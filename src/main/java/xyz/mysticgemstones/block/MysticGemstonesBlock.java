...
public class MysticGemstonesBlock {
    ...
    public static <T extends Block> T addBlock(String id, T block, boolean addBlockItem) {
        ...
        if (addBlockItem) {
            Registry.register(Registry.ITEM, identifier, new BlockItem(block, new FabricItemSettings().group(MysticGemstonesItem.ITEM_GROUP_BLOCKS)));
        }
        return block;
    }
    ...
    public static final StarstoneOreBlockItem STARSTONE_ORE_ITEM = addBlockItem(new Identifier(Constant.MOD_ID, Constant.STARSTONE_ORE), new StarstoneOreBlockItem(STARSTONE_ORE, new FabricItemSettings().group(MysticGemstonesItem.ITEM_GROUP_BLOCKS)));
    ...
    public static final BlockItem GEM_GRINDSTONE_ITEM = addBlockItem(new Identifier(Constant.MOD_ID, Constant.GEM_GRINDSTONE), new BlockItem(GEM_GRINDSTONE, new FabricItemSettings().group(MysticGemstonesItem.ITEM_GROUP_SPECIAL)));
    public static final BlockItem GEM_CRAFT_STATION_ITEM = addBlockItem(new Identifier(Constant.MOD_ID, Constant.GEM_CRAFT_STATION), new BlockItem(GEM_CRAFT_STATION, new FabricItemSettings().group(MysticGemstonesItem.ITEM_GROUP_SPECIAL)));
    public static final BlockItem ROCK_TUMBLER_ITEM = addBlockItem(new Identifier(Constant.MOD_ID, Constant.ROCK_TUMBLER), new BlockItem(ROCK_TUMBLER, new FabricItemSettings().group(MysticGemstonesItem.ITEM_GROUP_SPECIAL)));
    public static final BlockItem GEM_INFUSER_ITEM = addBlockItem(new Identifier(Constant.MOD_ID, Constant.GEM_INFUSER), new BlockItem(GEM_INFUSER, new FabricItemSettings().group(MysticGemstonesItem.ITEM_GROUP_SPECIAL)));
